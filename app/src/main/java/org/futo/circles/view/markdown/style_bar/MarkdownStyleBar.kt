...
import org.futo.circles.view.markdown.MarkdownEditText
...
class MarkdownStylesBar @JvmOverloads constructor(
    ...
    private fun setStylesButtons(){
        for (style in stylesList){
            when(style){
                MarkdownEditText.TextStyle.BOLD -> styleButtons.add(StyleButton(R.drawable.ic_bold, R.id.style_button_bold))
                MarkdownEditText.TextStyle.ITALIC -> styleButtons.add(StyleButton(R.drawable.ic_italic, R.id.style_button_italic))
                MarkdownEditText.TextStyle.STRIKE -> styleButtons.add(StyleButton(R.drawable.ic_strikethrough, R.id.style_button_strike))
                MarkdownEditText.TextStyle.UNORDERED_LIST -> styleButtons.add(StyleButton(R.drawable.ic_bullet_list, R.id.style_button_unordered_list))
                MarkdownEditText.TextStyle.ORDERED_LIST -> styleButtons.add(StyleButton(R.drawable.ic_number_list, R.id.style_button_ordered_list))
                MarkdownEditText.TextStyle.TASKS_LIST -> styleButtons.add(StyleButton(R.drawable.ic_check_box, R.id.style_button_task_list))
                MarkdownEditText.TextStyle.LINK -> styleButtons.add(StyleButton(R.drawable.ic_link, R.id.style_button_link))
                else ->{}
            }
        }
    }
