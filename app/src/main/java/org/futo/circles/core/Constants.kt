...
const val REGISTRATION_TOKEN_KEY_EXTENSION = "registration_token"
const val REGISTRATION_SUBSCRIPTION_KEY_EXTENSION = "subscription.google"
const val REGISTRATION_EMAIL_STAGE_KEY_PREFIX = "m.enroll.email"
