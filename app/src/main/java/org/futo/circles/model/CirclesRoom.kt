...
data class PrivateCirclesSpace(
    override val nameId: Int? = R.string.private_circles_space_name,
...
data class SharedCirclesSpace(
    override val nameId: Int? = R.string.shared_circles_space_name,
...
data class Circle(
    ...
    override val parentTag: String? = PRIVATE_CIRCLES_SPACE_TAG,
    override val type: String? = RoomType.SPACE
) : CirclesRoom(nameId, tag, parentTag, type)
