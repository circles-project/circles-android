...
class AdaptiveIconTransformation(
    private val adaptiveIconSize: Int,
    private val adaptiveIconOuterSides: Float
) : BitmapTransformation() {

    override fun updateDiskCacheKey(messageDigest: MessageDigest) {
        messageDigest.update(ID_BYTES)
        messageDigest.update(
            ByteBuffer.allocate(8).putInt(adaptiveIconSize).putFloat(adaptiveIconOuterSides).array()
        )
    }
    ...
    override fun transform(
        ...
        val insetBmp =
            Bitmap.createBitmap(adaptiveIconSize, adaptiveIconSize, Bitmap.Config.ARGB_8888)
    ...
    override fun hashCode() = Util.hashCode(
        ADAPTIVE_TRANSFORMATION_ID.hashCode(),
        Util.hashCode(adaptiveIconSize, Util.hashCode(adaptiveIconOuterSides))
    )
}