...
Java_org_futo_circles_bsspeke_BSSpekeUtils_generatePandV(JNIEnv *env, jobject thiz,
    ...
    int rc = bsspeke_client_generate_P_and_V((uint8_t *)p,(uint8_t *)v,(uint8_t *)blind_salt,(uint32_t)phf_blocks,(uint32_t)phf_iterations,(bsspeke_client_ctx*) client_context);
...
Java_org_futo_circles_bsspeke_BSSpekeUtils_generateA(JNIEnv *env, jobject thiz,
    ...
    int rc = bsspeke_client_generate_A((uint8_t *)blind_salt,(uint32_t)phf_blocks,(uint32_t)phf_blocks,(bsspeke_client_ctx*) client_context);
